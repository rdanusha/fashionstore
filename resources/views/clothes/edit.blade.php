...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Update Clothe</div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 order-md-1">
                                @include('layouts.flash-message')
                                <form method="post" id="clothes_form" action="{{route('clothes.update',$cloth->id)}}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ (isset($cloth))?$cloth->name:old('name')  }}" name="name"
                                               id="name" placeholder=""
                                               required="">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ (isset($cloth))?$cloth->product_code:old('product_code')  }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea
                                            class="form-control {{($errors->first('short_description')?'is-invalid':'')}}"
                                            name="description"
                                            id="description">{{ (isset($cloth))?$cloth->short_description:old('short_description')  }}</textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               name="cost"
                                               id="cost" placeholder="" required="" value="{{ (isset($cloth))?$cloth->cost:old('cost')  }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               name="color"
                                               id="color" placeholder="" required="" value="{{ (isset($cloth))?$cloth->color:old('color')  }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               name="size"
                                               id="size" placeholder="" required="" value="{{ (isset($cloth))?$cloth->size:old('size')  }}">
                                        ...
                                        @if($brands)
                                            <select name="brand_id" id="brand_id"
                                                ...
                                                @foreach($brands AS $brand)
                                                    <option @if($cloth->brand_id == $brand->id) selected @endif value="{{$brand->id}}">{{$brand->name}}</option>
                                                @endforeach
                                            </select>
